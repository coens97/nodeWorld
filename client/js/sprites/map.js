			...
			for(var tY = 0;tY<world.layers[l].height;tY++){//draw every row
				...
				for(var tX = 0;tX<layer.width;tX++){
					...
					if(dat==1||dat==2){
						...
						ctx.drawImage(m.tiles[1], (dat==3||dat==5)?0:world.tilesets[1].tilewidth, (dat==3||dat==4)?0:world.tilesets[1].tileheight, world.tilesets[1].tilewidth, world.tilesets[1].tileheight,this.x+tX*world.tilewidth*2,this.y+(tY-1)*world.tileheight*2, world.tilesets[1].tilewidth*2, world.tilesets[1].tileheight*2);		
					}
					c++;//C++ rules!
				}
			}
